...
<textarea rows="3" wire:model.blur="blockData.{{ $index }}.text" placeholder="{{ __('knowledge-base::kb.editor.meaning') }}" class="w-full rounded-lg border border-zinc-200 p-3 text-sm dark:border-zinc-800 dark:bg-zinc-950 dark:text-zinc-100"></textarea>
